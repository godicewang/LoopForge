...
/usr/bin/plutil -insert releaseMutationCapabilityClassification -string nonMutatingContainmentVeto "$PROVIDER_HARNESS_MANIFEST"
/usr/bin/plutil -insert workspaceMutationAvailable -bool false "$PROVIDER_HARNESS_MANIFEST"
/usr/bin/plutil -insert repositoryGenerationTelemetryDisposition -string nonMutatingNotApplicable "$PROVIDER_HARNESS_MANIFEST"
/usr/bin/plutil -insert resolvedRepositoryGenerationTelemetryRequired -bool false "$PROVIDER_HARNESS_MANIFEST"
...
/usr/bin/plutil -insert releaseMutationCapabilityClassification -string nonMutatingContainmentVeto "$BUILD_MANIFEST"
/usr/bin/plutil -insert workspaceMutationAvailable -bool false "$BUILD_MANIFEST"
/usr/bin/plutil -insert repositoryGenerationTelemetryDisposition -string nonMutatingNotApplicable "$BUILD_MANIFEST"
/usr/bin/plutil -insert resolvedRepositoryGenerationTelemetryRequired -bool false "$BUILD_MANIFEST"
